...
public class CaptureGUI extends JPanel implements ActionListener, ItemListener, TextListener {
    ...
    private static void createAndShowGUI() {
        ...
        String src = "/captureProgram/GUICode/u5.png";
        Image image = null;
        try {
    ...
    private void initComponents() {
        ...
        label_device.setIcon(new ImageIcon(getClass().getResource("/captureProgram/GUICode/u53.png"))); // NOI18N
        ...
        label_appType.setIcon(new ImageIcon(getClass().getResource("/captureProgram/GUICode/u53.png"))); // NOI18N
        ...
        label_network.setIcon(new ImageIcon(getClass().getResource("/captureProgram/GUICode/u53.png"))); // NOI18N
        ...
        label_inputType.setIcon(new ImageIcon(getClass().getResource("/captureProgram/GUICode/u53.png"))); // NOI18N
        ...
        label_outputFolder.setIcon(new ImageIcon(getClass().getResource("/captureProgram/GUICode/u53.png"))); // NOI18N
        ...
        button_chooseFile.setIcon(new ImageIcon(getClass().getResource("/captureProgram/GUICode/u118.png"))); // NOI18N
        ...
        button_chooseFolder.setIcon(new ImageIcon(getClass().getResource("/captureProgram/GUICode/u118.png"))); // NOI18N
        ...
        button_startUp.setIcon(new ImageIcon(getClass().getResource("/captureProgram/GUICode/u61.png")));
        ...
        button_continue.setIcon(new ImageIcon(getClass().getResource("/captureProgram/GUICode/u63.png")));
        ...
        button_suspend.setIcon(new ImageIcon(getClass().getResource("/captureProgram/GUICode/u65.png")));
        ...
        label_inputSource.setIcon(new ImageIcon(getClass().getResource("/captureProgram/GUICode/u53.png"))); // NOI18N
        ...
        jLabel8.setIcon(new ImageIcon(getClass().getResource("/captureProgram/GUICode/u53.png"))); // NOI18N
        ...
        jLabel12.setIcon(new ImageIcon(getClass().getResource("/captureProgram/GUICode/u53.png"))); // NOI18N
        ...
        jLabel14.setIcon(new ImageIcon(getClass().getResource("/captureProgram/GUICode/u53.png"))); // NOI18N
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        if (evt.getSource() == button_startUp) {
            ...
            if ("[请选择数据源]".equals(textField_inputSource.getText())
                ...
                JOptionPane.showMessageDialog(new JFrame(), msg, "Warn", JOptionPane.WARNING_MESSAGE);
                return;
            }
        ...
        protected ComboPopup createPopup() {
            ComboPopup cp = new BasicComboPopup(comboBox){
                ...
                protected void configurePopup() {
                    ...
                    setBorder(new LineBorder(new Color(248, 248, 248), 1));
                    setOpaque( false );
                    add( scroller );
    ...
    /*static class MyFileChooserUI extends BasicFileChooserUI{
        ...
        protected void installIcons(JFileChooser fc) {
            ...
            super.directoryIcon = new ImageIcon(getClass().getResource("/captureProgram/GUICode/u422.png"));
        }
    }*/
}
