package captureProgram.mainPro.mainpage;

import captureProgram.GUICode.CaptureGUI;
import captureProgram.mainPro.services.XPathConstant;
 ...
 * 文件描述：旅行交通类App
 */
public class LxjtAppJumpToMainPage {
    Document document ;
    Integer flag1 = 0;
    Integer flag2 = 0;
    Integer flag3 = 0;
        ...
        if (flag3 < 8) {
             ...
             */
                if (ImageView_list.size() == 0
                    ...
                    LinearLayout_Textview_list = document.selectNodes(XPathConstant.LINEARLAYOUT_TEXTVIEW_PATH);
